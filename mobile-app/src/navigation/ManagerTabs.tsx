          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                (navigation as any).navigate('ManagerTabs', { screen: 'OpenShifts' });
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setDrawerVisible(false);
                (navigation as any).navigate('ManagerTabs', { screen: 'Schedules' });
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setDrawerVisible(false);
                (navigation as any).navigate('ManagerTabs', { screen: 'Visits' });
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setDrawerVisible(false);
                (navigation as any).navigate('ManagerTabs', { screen: 'Checklists' });
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setDrawerVisible(false);
                (navigation as any).navigate('ManagerTabs', { screen: 'Availability' });
              }}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setDrawerVisible(false);
                (navigation as any).navigate('ManagerTabs', { screen: 'Profile' });
              }}
            >
